    ...
    <header className="bg-white shadow-sm relative z-50 py-4 px-2 [box-shadow:0_1px_4px_rgba(38,_34,_33,_.12)]">
      <div className="w-full max-w-[980px] mx-auto flex items-center justify-between">
        ...
        <div className="flex gap-2.5">
          <Link href="/sp/private/view/question/" className="min-w-10 flex flex-col items-center gap-2">
            <Image
          ...
          <button
            ...
            className="min-w-10 flex flex-col items-center gap-2"
          >
            <Image
              src="/icons/menu.svg"
              alt=""
      ...
      {/* MENU OVERLAY */}
      {open && (
        <div className="fixed inset-0 text-base z-50 overflow-auto bg-white">
              ...
              <div className="w-full md:max-w-[66.6666667%] mx-auto space-y-4">
                <div className="px-6 md:px-8 py-4 md:py-6 bg-white">
                  ...
                  <div className="flex max-md:flex-col justify-center">
                    <div className="mb-3 md:w-1/3 w-full md:mx-2">
                      <Link
                        href="/"
                        onClick={() => setOpen(false)}
                  ...
                  <div className="mb-14" key={index}>
                    ...
                    <ul className="flex flex-wrap -mx-6 overflow-hidden">
                      {menu.items.map((item, i) => (
                        <li className="md:w-1/2 w-full px-6" key={i}>
                          <Link
                            href={item.href}
                            onClick={() => setOpen(false)}
